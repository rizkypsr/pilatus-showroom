...
import com.showroom.pilatus.databinding.FragmentEditEmailBinding
...
class EditEmailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val dataEmail = EditEmailFragmentArgs.fromBundle(arguments as Bundle).email

        binding.inputProfileEmail.setText(dataEmail)
